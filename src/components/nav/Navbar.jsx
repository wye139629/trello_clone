...
const Button = tw.button`rounded border-0 bg-transparent py-[6px] px-[10px] cursor-pointer text-white font-semibold hover:bg-gray-200/30`
...
function Navbar() {
  return (
    <nav css={tw`flex px-[6px] py-[8px] bg-black/50 text-white items-center`}>
      <div>
        <a href="./">
          <Button css={tw`text-lg leading-4`}>Willo</Button>
        </a>
      </div>
      <div css={tw`px-2`}>
        <Button>
      ...
      <div css={tw`ml-auto flex items-center space-x-2`}>
        ...
        <button css={tw`bg-cyan-500 rounded-full border-0 cursor-pointer`}>
